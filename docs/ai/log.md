...
| 26 Sep 2026 | Step 22: added a light theme as the default, with a warm off-white and teal palette, a matching dark theme and a switch in the header that the browser remembers, with WCAG AA contrast in both. |
| 26 Sep 2026 | Step 23: added the app icon, a document of possible improvements and up-to-date design documents, and linked the demo video; the application is ready for review. |
